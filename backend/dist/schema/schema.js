...
var LaunchType = new graphql_1.GraphQLObjectType({
    name: "Launch",
...
//RocketType
var RocketType = new graphql_1.GraphQLObjectType({
    name: 'Rocket',
    fields: function () { return ({
            ...
            resolve: function (parent, args) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, axios_1.default.get('https://api.spacexdata.com/v3/launches')];
                            case 1:
                                res = _a.sent();
        ...
        launch: {
            ...
            resolve: function (parent, args) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, axios_1.default.get("https://api.spacexdata.com/v3/launches/".concat(args.flight_number))];
                            case 1:
                                res = _a.sent();
                                return [2 /*return*/, res.data];
                        }
